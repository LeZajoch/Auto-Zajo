...
<div class="container my-5">
    <div class="row">
        <div class="car-info col-md-8 bg-dark text-warning">
            <h1 class="bg-dark">Hyundai Tucson 2.0CRDi 4x4</h1>
            <div id="carCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://www.autoesa.cz/files/cars/625305157/950_713_e/625305157-2.jpg?1716485331" class="d-block w-100" alt="Car Image 1">
                    </div>
                    <div class="carousel-item">
                        <img src="https://www.autoesa.cz/files/cars/625305157/950_713_e/625305157-3.jpg?1716485331" class="d-block w-100" alt="Car Image 2">
                    </div>
                    <div class="carousel-item">
                        <img src="https://www.autoesa.cz/files/cars/625305157/950_713_e/625305157-4.jpg?1716485331" class="d-block w-100" alt="Car Image 3">
                    </div>
                </div>
            ...
            <div class="car-info mt-3" style="background-color: #272b30 !important;">
                ...
                <table class="table table-1">
                    <tr>
                        ...
                        <td class="text-white" style="background-color: #353940 !important;">Hyundai </td>
                    </tr>
                    <tr>
                        <th class="text-warning" style="background-color: #2f3339 !important;">Model</th>
                        <td class="text-white" style="background-color: #353940 !important;">Tucson</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-white" style="background-color: #353940 !important;">70 522 km</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-white" style="background-color: #353940 !important;">136 kW (150 PS)</td>
                    </tr>
                    <tr>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="pricing-box bg-dark">
                            ...
                            <p class="price">439 999 Kč</p>
                            <p class="price-note">Cena bez DPH činí 347 599 Kč</p>
                        </div>
                    </div>
                </div>
            </div>
