...
<div class="container my-5">
    <div class="row">
        <div class="car-info col-md-8 bg-dark text-warning">
            <h1 class="bg-dark">Renault Mégane 1.2TCe Limited</h1>
            <div id="carCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://www.autoesa.cz/files/cars/846287579/950_713_e/846287579-2.jpg?1711648852" class="d-block w-100" alt="Car Image 1">
                    </div>
                    <div class="carousel-item">
                        <img src="https://www.autoesa.cz/files/cars/846287579/950_713_e/846287579-3.jpg?1711648852" class="d-block w-100" alt="Car Image 2">
                    </div>
                    <div class="carousel-item">
                        <img src="https://www.autoesa.cz/files/cars/846287579/950_713_e/846287579-4.jpg?1711648852" class="d-block w-100" alt="Car Image 3">
                    </div>
                </div>
            ...
            <div class="car-info mt-3" style="background-color: #272b30 !important;">
                ...
                <table class="table table-1">
                    <tr>
                        ...
                        <td class="text-white" style="background-color: #353940 !important;">Renault</td>
                    </tr>
                    <tr>
                        <th class="text-warning" style="background-color: #2f3339 !important;">Model</th>
                        <td class="text-white" style="background-color: #353940 !important;">Mégane</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-white" style="background-color: #353940 !important;">124 377 km</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-white" style="background-color: #353940 !important;">1,198 ccm</td>
                    </tr>
                    <tr>
                        <th class="text-warning" style="background-color: #2f3339 !important;">Výkon</th>
                        <td class="text-white" style="background-color: #353940 !important;">85 kW (150 PS)</td>
                    </tr>
                    <tr>
                        <th class="text-warning" style="background-color: #2f3339 !important;">Barva</th>
                        <td class="text-white" style="background-color: #353940 !important;">šedá</td>
                    </tr>
                    <tr>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="pricing-box bg-dark">
                            ...
                            <p class="price">115 999 Kč</p>
                            <p class="price-note">Cena bez DPH činí 91 639 Kč</p>
                        </div>
                    </div>
                </div>
            </div>
