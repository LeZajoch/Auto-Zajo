...
<div class="container my-5">
    <div class="row">
        <div class="car-info col-md-8 bg-dark text-warning">
            <h1 class="bg-dark">Škoda Octavia II 1.6 MPi Ambiente</h1>
            ...
            <div class="car-info mt-3" style="background-color: #272b30 !important;">
                ...
                <table class="table table-1">
                    <tr>
                        ...
                        <td class="text-white" style="background-color: #353940 !important;">Škoda </td>
                    </tr>
                    <tr>
                        <th class="text-warning" style="background-color: #2f3339 !important;">Model</th>
                        <td class="text-white" style="background-color: #353940 !important;">Octavia</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-white" style="background-color: #353940 !important;">175 601 km</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-white" style="background-color: #353940 !important;">75 kW (150 PS)</td>
                    </tr>
                    <tr>
