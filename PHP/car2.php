...
<div class="container my-5">
    <div class="row">
        <div class="car-info col-md-8 bg-dark text-warning">
            ...
            <div class="car-info mt-3" style="background-color: #272b30 !important;">
                ...
                <table class="table table-1">
                    ...
                    <tr>
                        <th class="text-warning" style="background-color: #2f3339 !important;">V provozu od</th>
                        <td class="text-white" style="background-color: #353940 !important;">09/2019</td>
                    </tr>
                    <tr>
        ...
        <div class="col-md-4">
            ...
            <div class="car-info mt-4 bg-dark">
                <h2 class="text-warning">Cena</h2>
                <p style="color: #ffca2e !important;">Akční Cena: <strong style="color: #ffea00 !important;">338,999 Kč</strong></p>
                <p style="color: #ffca2e !important;">Cena Hotově: <strong style="color: #ffea00 !important;">378,999 Kč</strong></p>
            </div>
        </div>
    </div>
</div>
